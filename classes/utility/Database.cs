...
namespace Essence.classes
{
    public class Database : Script
    {
        ...
        static string vehicleTable = @"CREATE TABLE IF NOT EXISTS
                            ...
                            [FrontBumper] INTEGER DEFAULT 0,
                            [RearBumper] INTEGER DEFAULT 0,
                            [SideSkirt] INTEGER DEFAULT 0,
                            [Exhaust] INTEGER DEFAULT 0,
                            [Frame] INTEGER DEFAULT 0,
                            [Grille] INTEGER DEFAULT 0,
                            [Hood] INTEGER DEFAULT 0,
                            [Fender] INTEGER DEFAULT 0,
                            [RightFender] INTEGER DEFAULT 0,
                            [Roof] INTEGER DEFAULT 0,
                            [Engine] INTEGER DEFAULT 0,
                            [Brakes] INTEGER DEFAULT 0,
                            [Transmission] INTEGER DEFAULT 0,
                            [Horns] INTEGER DEFAULT 0,
                            [Suspension] INTEGER DEFAULT 0,
                            [Armor] INTEGER DEFAULT 0,
                            [Turbo] INTEGER DEFAULT 0,
                            [Xenon] INTEGER DEFAULT 0,
                            [FrontWheels] INTEGER DEFAULT 0,
                            [BackWheels] INTEGER DEFAULT 0,
                            [PlateHolders] INTEGER DEFAULT 0,
                            [TrimDesign] INTEGER DEFAULT 0,
                            [Ornaments] INTEGER DEFAULT 0,
                            [DialDesign] INTEGER DEFAULT 0,
                            [SteeringWheel] INTEGER DEFAULT 0,
                            [ShiftLever] INTEGER DEFAULT 0,
                            [Plaques] INTEGER DEFAULT 0,
                            [Hydraulics] INTEGER DEFAULT 0,
                            [Livery] INTEGER DEFAULT 0,
                            [Plate] INTEGER DEFAULT 0,
                            [WindowTint] INTEGER DEFAULT 0
                            )";

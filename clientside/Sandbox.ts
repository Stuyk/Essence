...
class LockPick {
    ...
    drawLockPick() {
        ...
        API.dxDrawTexture("clientside/images/lockpick/lockpick_2.png", new Point(halfScreenWidth - 143, halfScreenHeight - 143), new Size(286, 286), 0, 255, 255, 255, 255);
...
function newLockPickMiniGame() {
    API.triggerServerEvent("Request_Lockpick_Minigame");
